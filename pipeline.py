...
def plot_qc(adata, group):
    ...
    axes[0].hist(adata.obs['total_counts'], bins=50, alpha=0.7, color='steelblue', edgecolor='black')
    ...
    axes[1].hist(adata.obs['n_genes_by_counts'], bins=50, alpha=0.7, color='seagreen', edgecolor='black')
    ...
    axes[2].hist(adata.obs['pct_counts_mt'], bins=50, alpha=0.7, color='darkorange', edgecolor='black')
...
def process_qc(adata):
    ...
    adata = adata[adata.obs['n_genes_by_counts'] > 300, :]  # Filter out extreme outliers
